...
function SeverityBadge({ severity }: { severity: string }) {
  ...
  const [text, bg] = map[severity?.toLowerCase()] || [
    '#94a3b8',
...
export default function App() {
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      setCamError(
        'No camera/microphone access. Please allow permissions in your browser settings and try again.'
      );
    }
  };
  ...
  const runAnalysis = async (
    ...
    setAnalysisStep(0);
    setScreen('analyzing');
    const timers = [1800, 3600, 5400].map((ms, i) =>
...
{"overallScore":<integer 1-10>,"summary":"<3 sentences: direct, honest assessment>","categories":[{"name":"Speech Flow","score":<1-10>,"icon":"🗣️","comment":"<1 specific sentence>"},{"name":"Tone & Expression","score":<1-10>,"icon":"🎵","comment":"<1 specific sentence>"},{"name":"Clarity & Structure","score":<1-10>,"icon":"🧩","comment":"<1 specific sentence>"},{"name":"Speaking Pace","score":<1-10>,"icon":"⏱️","comment":"<1 sentence referencing the ${wpm} WPM>"},{"name":"Confidence & Presence","score":<1-10>,"icon":"💪","comment":"<1 specific sentence>"}],"issues":[{"type":"Filler Words","severity":"<low|medium|high>","detail":"<specific assessment>"},{"type":"Pauses & Hesitations","severity":"<low|medium|high>","detail":"<specific assessment>"},{"type":"Sentence Structure","severity":"<low|medium|high>","detail":"<specific observation>"},{"type":"Persuasiveness","severity":"<low|medium|high>","detail":"<honest assessment>"}],"tips":["<Tip 1>","<Tip 2>","<Tip 3>","<Tip 4>","<Tip 5>"]}`;
          ...
          messages: [
            {
              role: 'system',
              content:
                'You are a world-class rhetoric and communication coach. Always respond with valid JSON only, no markdown, no extra text.',
            },
  ...
  const handleAnalyze = () => {
    if (!transcript || transcript.trim().split(/\s+/).length < 15) {
      setApiError(
        'Not enough speech detected. Please speak for at least 20–30 seconds.'
      );
      return;
    }
    ...
    <div style={{ width: '100%', background: G.bg }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          >
            SpeakCoach<span style={{ color: G.accent }}>AI</span>
          </span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          {user ? (
          ...
          <button
            className="btn"
            onClick={() => {
              if (!canAnalyze) setShowUpgrade(true);
              else setScreen('record');
            }}
            style={{
              background: `linear-gradient(135deg,${G.accent},#8b5cf6)`,
              color: '#fff',
      ...
      >
        ...
        <h1
          style={{
            ...
            lineHeight: 1.08,
            marginBottom: 22,
            background: `linear-gradient(135deg,${G.text} 0%,rgba(241,243,249,0.5) 100%)`,
        ...
        >
          Record 60 seconds and instantly discover what to improve. AI analyzes
          your tone, pauses, filler words, and presence — with personalized,
          actionable feedback.
        </p>
        <div
          style={{
        ...
        >
          <button
            ...
            style={{
              ...
              padding: '14px 30px',
              borderRadius: 12,
              boxShadow: `0 8px 28px ${G.accentGlow}`,
            }}
          >
            🎙️ Start for Free
          </button>
        ...
        {!user && (
          <p style={{ color: G.muted, fontSize: 13, marginTop: 14 }}>
        ...
        {[
          {
            ...
            text: '1–10 score across 5 categories: Flow, Tone, Clarity, Pace, and Presence.',
          },
          {
            icon: '🐛',
            title: 'Catch Your Mistakes',
            text: 'Filler words, long pauses, and hesitations automatically detected and graded.',
          },
          {
            icon: '💡',
            title: 'Personal Tips',
            text: '5 immediately actionable tips tailored to your specific weaknesses.',
          },
          {
            icon: '📈',
            title: 'Track Progress',
            text: 'Analyze multiple times and watch your improvement over time.',
          },
        ].map((f, i) => (
          <div
            key={i}
      ...
      >
        ...
        <p style={{ color: G.muted, marginBottom: 40, fontSize: 15 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ color: G.muted, fontSize: 13, marginBottom: 22 }}>
              forever
            </div>
            <ul
              style={{
          ...
          <div
            style={{
              background: `linear-gradient(135deg,${G.accentSoft},rgba(139,92,246,0.07))`,
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                fontSize: 14,
                boxShadow: `0 5px 18px ${G.accentGlow}`,
              }}
            >
              Activate Pro →
            </button>
      ...
      >
        ...
        >
          <button
            ...
            style={{ color: G.muted, background: 'none', fontSize: 14 }}
          >
            ← Home
          </button>
          <span
            ...
            {[
              ...
              <button
                ...
                style={{
                  background:
                    mode === m
                      ? `linear-gradient(135deg,${G.accent},#8b5cf6)`
                      : 'none',
                  ...
                  <>
                    ...
                    >
                      <div
                        style={{
                          height: '100%',
                          width: `${(recTime / 60) * 100}%`,
                          background: `linear-gradient(90deg,${G.accent},#8b5cf6)`,
                ...
                >
                  {!recording && !transcript && !transcribing ? (
                    <>
                      ...
                      >
                        Speak for 60 seconds on any topic — introduce yourself,
                        pitch an idea, or give a short speech.
                      </div>
                      <button
                        className="btn"
                        ...
                        style={{
                          ...
                          borderRadius: 11,
                          width: '100%',
                          boxShadow: '0 5px 18px rgba(239,68,68,0.3)',
                        }}
                      >
                        🔴 Start Recording
                      </button>
                      ...
                      <div style={{ marginBottom: 14 }}>
                        ...
                        <div
                          style={{
                            ...
                            fontWeight: 900,
                            fontFamily: '"Playfair Display",serif',
                            color: tLeft <= 10 ? '#ef4444' : G.text,
                            lineHeight: 1,
                          }}
                        >
                          {tLeft}
                          <span style={{ fontSize: 18, color: G.muted }}>
                            s
                          </span>
                        </div>
                      </div>
                    ...
                    >
                      <span
                        style={{
                          fontSize: 11,
                          fontWeight: 700,
                          color: transcribing ? G.accent : '#22c55e',
                  ...
                  <div className="fadeUp">
                    ...
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 11,
                        width: '100%',
                        boxShadow: `0 6px 20px ${G.accentGlow}`,
                      }}
                    >
                      🔍 Analyze Now →
                    </button>
            ...
            >
              ...
              >
                <div
                  ...
                  style={{
                    background: drag ? G.accentSoft : G.card,
                ...
                >
                  ...
                  {uploadFile ? (
                    ...
                    <>
                      ...
                      <div style={{ color: G.muted, fontSize: 13 }}>
                        MP4, MOV, WebM, MP3, M4A · min. 60 seconds
                      </div>
                    </>
                  )}
                </div>
                ...
                {uploadFile && (
                  ...
                  >
                    ...
                    <textarea
                      value={uTranscript}
                      onChange={(e) => setUTranscript(e.target.value)}
              ...
              >
                ...
                {!uploadFile ? (
                  <div
                    style={{ fontSize: 13, color: G.muted, lineHeight: 1.7 }}
                  >
                  ...
                  <>
                    {(
                      [
                        [
                          'File',
                          uploadFile.name.length > 22
                            ? uploadFile.name.slice(0, 22) + '…'
                            : uploadFile.name,
                        ],
                        ['Duration', `${uploadDur}s`],
                        [
                          'Transcript',
                          uTranscript
                            ? `${uTranscript.split(/\s+/).length} words`
                            : 'Not yet',
                        ],
                      ] as [string, string][]
                    ).map(([k, v]) => (
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (
                          !uTranscript ||
                          uTranscript.trim().split(/\s+/).length < 15
                        ) {
                          setApiError('Please add a transcript first.');
                          return;
                        }
    ...
    >
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ color: G.muted, fontSize: 14 }}>
          AI is reviewing your presentation in detail
        </p>
      </div>
      <div
        style={{
      ...
      >
        {[
          ...
          'Analyzing tone & pace…',
          'Detecting patterns & errors…',
          'Generating personal tips…',
        ].map((step, i) => (
          <div
            key={i}
            style={{
          ...
          >
            <div
              style={{
                ...
                height: 22,
                borderRadius: '50%',
                border: `2px solid ${i < analysisStep ? G.accent : G.border}`,
                background: i < analysisStep ? G.accentSoft : 'none',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: 10,
            ...
            <span
              style={{
                fontSize: 13,
                color: i <= analysisStep ? G.text : G.muted,
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 220 }}>
              ...
              <p style={{ color: G.muted, fontSize: 14, lineHeight: 1.7 }}>
                {results.summary}
              </p>
              ...
              {results.categories?.map((cat: any, i: number) => (
                <div key={i} style={{ marginBottom: i < 4 ? 16 : 0 }}>
                  ...
                  >
                    ...
                    <span
                      style={{ fontSize: 13, fontWeight: 800, color: cols[i] }}
                    >
                      {cat.score}/10
                    </span>
                  </div>
              ...
              {results.issues?.map((issue: any, i: number) => (
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${G.border}`,
                    borderRadius: 11,
                    marginBottom: i < results.issues.length - 1 ? 10 : 0,
                  }}
                >
                  <div
                    style={{
                  ...
                  <div
                    style={{ fontSize: 12, color: G.muted, lineHeight: 1.55 }}
                  >
                    {issue.detail}
                  </div>
                </div>
    ...
    <>
      ...
      {showAuth && (
        <Modal title="Create Account" onClose={() => setShowAuth(false)}>
          ...
          >
            Save your progress and access your analyses anytime.
          </div>
          <input
            value={authEmail}
          ...
          <p
            style={{ fontSize: 12, color: G.muted, textAlign: 'center' as any }}
          >
            No spam. Just your account settings.
          </p>
        </Modal>
      )}
      ...
      {showUpgrade && (
        <Modal title="Unlock Pro" onClose={() => setShowUpgrade(false)}>
          ...
          >
            {analysesUsed >= FREE_LIMIT
              ? '🔒 All 3 free analyses used. Upgrade for unlimited access.'
              : '⚡ Get unlimited analyses and all features.'}
          </div>
          {[
            {
              plan: 'weekly',
            ...
            },
            {
              plan: 'onetime',
              label: '$29 one-time',
              sub: 'Lifetime access · no subscription',
              badge: 'POPULAR',
            },
            ...
            <button
              ...
              style={{
                background: plan === 'onetime' ? G.accentSoft : G.surface,
                border: `1px solid ${plan === 'onetime' ? G.accent : G.border}`,
                borderRadius: 13,
                padding: '14px 18px',
